...
// 从 local.properties 或环境变量读取 release 签名信息（在 android 块外，避免被 Gradle DSL 的 java 属性遮蔽）
...
android {
    ...
    signingConfigs {
        create("release") {
            storeFile = file(localProps.getProperty("RELEASE_STORE_FILE") ?: System.getenv("RELEASE_STORE_FILE") ?: "release.keystore")
